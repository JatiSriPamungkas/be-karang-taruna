...
export const getAllActiveApprovedMember = async () => {
	const SQLQuery = `SELECT * FROM members WHERE status = 'approved' AND is_active = true;`;
...
export const updateStatusMembers = (id_member, status) => {
